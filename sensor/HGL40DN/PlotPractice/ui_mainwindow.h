...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        distancePlot->setGeometry(QRect(230, 130, 741, 521));
...
"}"));
        ...
        distanceLabel->setGeometry(QRect(220, 20, 211, 61));
        QFont font;
        ...
        consoleLog->setGeometry(QRect(1030, 420, 501, 231));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        distanceLabel->setText(QApplication::translate("MainWindow", "164 cm", 0));
